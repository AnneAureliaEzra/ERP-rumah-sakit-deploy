    ...
    <div className="p-8 bg-slate-50 min-h-screen ml-64 flex flex-col items-center justify-center text-center font-sans">
      <div className="bg-white p-10 rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 max-w-lg relative overflow-hidden">
         ...
         <div className="relative z-10">
            <div className="w-20 h-20 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-cyan-200 -rotate-3 hover:-rotate-6 transition-transform">
            <PackageOpen className="w-10 h-10 text-white" />
            </div>
            <h2 className="text-3xl font-extrabold text-slate-900 mb-3">Rantai Pasok & Farmasi</h2>
            <p className="text-slate-500 leading-relaxed mb-8">
            Antarmuka Inventaris Farmasi, Pengadaan (PR/PO), dan Logistik Stok sedang dalam pemeliharaan terjadwal untuk peningkatan performa.
            </p>
            ...
            Lihat Peringatan Stok <ArrowRight className="w-4 h-4" />
            </button>
        </div>
      </div>
    </div>
